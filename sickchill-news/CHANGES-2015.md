...
* Fix setting git_remote_url, force to SickChill org 
...
* Switch from SiCKRAGETV org to SickChill org (good luck on your own ech3l0n)
...
* Fixed: Submodule init/update on SickChill update
* Fixed: Databse version checks in updater
* Fixed: Embedded subtitles not detected
* Fixed: SickChill invalid torrent
...
* Changed the InitScripts to use variable names and file names referencing SickChill, instead of SickBeard, to prevent conflicts, and improve readability
...
* Changed sr_tvrage_scene_exceptions to use SickChill repo instead of echel0n's
...
* Use SickChill date preset config to show trakt first aired in recommendations
...
[Changelog 2016](https://github.com/SickChill/sickchill.github.io/raw/master/sickchill-news/CHANGES.md)
[Changelog 2015](https://github.com/SickChill/sickchill.github.io/raw/master/sickchill-news/CHANGES-2015.md)
[Changelog 2014](https://github.com/SickChill/sickchill.github.io/raw/master/sickchill-news/CHANGES-2014.md)
